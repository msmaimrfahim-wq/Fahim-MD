...
const axios = require('axios'); // অনলাইন ইমেজ ডাউনলোডের জন্য axios অ্যাড করা হলো ভাই
...
// 🖼️ ইমেজ ডাউনলোডের লজিক সহ কাস্টম ইমেজ ফাংশন ভাই
async function sendWithImage(sock, chatId, text, message) {
    try {
        if (settings.menuPicUrl && settings.menuPicUrl.startsWith('http')) {
            const response = await axios.get(settings.menuPicUrl, { responseType: 'arraybuffer' });
...
// 🌐 বাটন মেনুর জন্য ইমেজ লোডার ফাংশন ভাই
...
    const menuImage = await loadMenuImage();
